...
@Component({
  selector: 'app-grafica-horizontalbar-h',
  templateUrl: './grafica-horizontalbar-h.component.html',
  styleUrls: ['./grafica-horizontalbar-h.component.scss']
})
export class GraficaHorizontalbarHComponent implements OnInit {

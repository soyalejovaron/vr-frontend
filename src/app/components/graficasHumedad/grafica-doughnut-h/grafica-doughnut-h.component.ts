...
@Component({
  selector: 'app-grafica-doughnut-h',
  templateUrl: './grafica-doughnut-h.component.html',
  styleUrls: ['./grafica-doughnut-h.component.scss']
})
export class GraficaDoughnutHComponent implements OnInit {

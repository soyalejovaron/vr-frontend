...
@Component({
  selector: 'app-grafica-radar-h',
  templateUrl: './grafica-radar-h.component.html',
  styleUrls: ['./grafica-radar-h.component.scss']
})
export class GraficaRadarHComponent implements OnInit {

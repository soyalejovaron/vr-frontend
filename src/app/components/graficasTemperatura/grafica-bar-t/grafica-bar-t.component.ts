...
@Component({
  selector: 'app-grafica-bar-t',
  templateUrl: './grafica-bar-t.component.html',
  styleUrls: ['./grafica-bar-t.component.scss']
})
export class GraficaBarTComponent implements OnInit {

...
@Component({
  selector: 'app-grafica-polararea-t',
  templateUrl: './grafica-polararea-t.component.html',
  styleUrls: ['./grafica-polararea-t.component.scss']
})
export class GraficaPolarareaTComponent implements OnInit {

...
@Component({
  ...
  styleUrls: ['./graficas-temperatura.component.scss']
})
export class GraficasTemperaturaComponent implements OnInit {
  ...
  constructor(private aRoute: ActivatedRoute, protected _sensorTemperaturaService: SensorTemperaturaService, private toastr: ToastrService ) {
    this.getSensor();
    this.getRegistro();
